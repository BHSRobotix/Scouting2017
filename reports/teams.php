        ...
        <table class="table table-striped">
            ...
            ?>
                <tr>
                    ...
                    ?>
                        <a class="btn <?= $robotPicBtnClass ?>" href="/scout/pitscouting.php?tmNum=<?= $row["number"] ?>&pictureType=robot"><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span></a>
                        <a class="btn <?= $driverPicBtnClass ?>" href="/scout/pitscouting.php?tmNum=<?= $row["number"] ?>&pictureType=driver"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></a>
                    </td>
