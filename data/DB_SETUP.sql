...
CREATE TABLE IF NOT EXISTS `performances` (
  ...
  `eventkey` varchar(11) NOT NULL,
  `teamnumber` int(5) NOT NULL,
  `functional_code` varchar(16) NOT NULL,
  `functional_comments` varchar(80) NOT NULL,
  `auto_mobility` varchar(16) DEFAULT NULL,
  `auto_gear` varchar(16) DEFAULT NULL,
  `auto_gear_peg_location` varchar(16) DEFAULT NULL,
  `auto_hopper` varchar(16) DEFAULT NULL,
  ...
  `tele_fuel_acquire_floor` int(5) DEFAULT NULL,
  `tele_fuel_acquire_hopper` int(5) DEFAULT NULL,
  `tele_fuel_acquire_station` int(5) DEFAULT NULL,
  `tele_shot_low_success` int(5) DEFAULT NULL,
  `tele_shot_high_success` int(5) DEFAULT NULL,
  `tele_shot_location` varchar(12) DEFAULT NULL,
  ...
  `tele_climb_attempt` varchar(12) DEFAULT NULL,
  `tele_climb_outcome` varchar(12) DEFAULT NULL,
  `tele_defense` varchar(12) DEFAULT NULL,
  `tele_defense_comments` varchar(80) DEFAULT NULL,
  `comment` text,
